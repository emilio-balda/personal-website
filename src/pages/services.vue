...
<template>
  <div class="flex flex-wrap items-center justify-center">
    <div class="flex flex-wrap items-stretch justify-center lg:w-5/6">
      <perfect-scrollbar v-for="item in content" :key="item.title" class="flex flex-col justify-between  items-center w-[19em] md:w-90 mt-4 mb-2 rounded-lg overflow-hidden mx-4 neumorphic-shadow dark:bg-background-900 transition-all duration-300 hover:-translate-y-2">
