...
export default defineConfig({
  shortcuts: [
    ...
    ['icon-btn', 'inline-block cursor-pointer select-none transition duration-200 ease-in-out hover:opacity-100 hover:text-primary-500 text-background-500 dark:text-background-100'],
  ],
  presets: [
    presetUno(),
    presetAttributify(),
